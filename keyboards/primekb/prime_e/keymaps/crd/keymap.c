...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_CTES, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,        KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL, KC_LALT,          KC_LGUI, KC_SPM1,                       KC_SPM1, KC_RALT,                   KC_RGUI, KC_RCTL
  ),

  [1] = LAYOUT(
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, _______,
    _______, KC_MINS, KC_HOME, KC_PGDN, KC_PGUP, KC_END,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, _______,
    _______, _______, _______, _______, _______, _______,     _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS, _______,
    _______, _______,          _______, KC_BSM2,              KC_BSM2,          _______,          _______, _______
  ),

  [2] = LAYOUT(
    RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,       KC_F6,   KC_F12,  _______, KC_MINS, KC_EQL,  _______, _______,
