...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_reviung34(
    ...
    KC_Z,    KC_X,    KC_C,    L2_V,    KC_B,    KC_N,    L2_M, KC_COMM,  KC_DOT, KC_SLSH,
    KC_SPM1,  XXXXXXX, XXXXXXX,              KC_SPM1
  ),

  [1] = LAYOUT_reviung34(
        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        KC_GESC, KC_HOME, KC_PGDN, KC_PGUP,  KC_END, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, KC_QUOT,
        KC_LSFT,  KC_TAB,  KC_GRV, KC_MINS,  KC_TAB,  KC_ENT,  KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS,
        KC_BSPC, KC_BSPC, KC_BSPC,            KC_BSPC
  ),
  
  [2] = LAYOUT_reviung34(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BRIU, KC_VOLU, XXXXXXX, XXXXXXX, XXXXXXX,   RESET,
        CMD_A,  DC_PRV, DC_NXT,  XXXXXXX, XXXXXXX, KC_MUTE, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX,
        CMD_Z,   CMD_X,   CMD_C,   CMD_V, KC_BRID, KC_VOLD, ZM_MUTE, ZM_VMUT, ZM_SHAR, ZM_WMIN,
        KC_BSPC, KC_BSPC, KC_BSPC,            KC_BSPC
  ),
};
