...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BL] = LAYOUT_60_tsangan_hhkb(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_UP, MO(_FL),
		KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             CMD_LFT, ALT_DWN, CTL_RHT
	),
	...
	[_CL] = LAYOUT_60_tsangan_hhkb(
		_______, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______, _______, _______, _______,  _______, _______,
		RGB_MOD, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
