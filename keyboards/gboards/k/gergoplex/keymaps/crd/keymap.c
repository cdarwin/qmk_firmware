...
[0] = LAYOUT_gergoplex(
    ...
    KC_LCTA,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,  KC_CTSC,
    KC_LSHZ,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT,  KC_SHSL,
    /*             */ KC_LGUI, KC_BSM1,  KC_ENT,  KC_TAB, KC_SPM1, KC_ALTG),
[1] = LAYOUT_gergoplex(
    ...
    /*             */ _______, KC_BSM2, KC_TAB,  KC_ENT,  KC_BSM2, _______),
[2] = LAYOUT_gergoplex(
