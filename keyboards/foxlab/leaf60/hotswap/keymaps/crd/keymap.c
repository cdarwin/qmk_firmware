...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_60_tsangan_hhkb(
    ...
    KC_LCTL, XXXXXXX, KC_LGUI,                            KC_SPC,                                      KC_RALT, XXXXXXX, KC_RCTL
  ),
  [_FL] = LAYOUT_60_tsangan_hhkb(
    ...
    TO(_CL), _______, _______,                            _______,                                     _______, _______, _______
  ),
  [_CL] = LAYOUT_60_tsangan_hhkb(
    ...
    TO(_BL), XXXXXXX, XXXXXXX,                            XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX
  )
};
